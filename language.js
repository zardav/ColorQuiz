lang = {
  'he': {
      ...
      'about': `שלום רב, לפניך שאלון על הבדל תפיסתי בין צבעים.
...
<div style="float: right";>דוד זר, סטודנט
ד"ר אופיר פלא, מנחה</div>`,
      'startquiz1': 'התחל',
      'thanks!': `תודה רבה על תשובותיכם.
...
תודה!`,
  ...
  'en': {
      ...
      'about': `This is a questionnaire on perceptual color difference.
