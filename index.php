...
<html dir="<?php print $lang['lang_dir']; ?>" lang="<?php print $lang_key; ?>">
    <head>
        ...
        <meta charset="UTF-8" />
        <!--<meta name="description" content="שאלון פשוט וידיותי על דמיון בין צבעים, מותאם למחשב ולנייד." />‎-->
...
"><img id="end_button" class="img_button" src="Delete.png"></div>
                            <div style="padding-right: 6.25vh;" data-lang="is_there_any_similarity"><?php print $lang['is_there_any_similarity']; ?></div>
                </td>
                <td class="top">
                    <div class="top-left">
        ...
        <table class="thanks">
            ...
            <tr><td class="menu_button" id="continue_button" data-lang="continue"><?php print $lang['continue']; ?></td></tr>
            <tr><td class="menu_button" id="menu_button" data-lang="menu"><?php print $lang['menu']; ?></td></tr>
        </table>
    </body>
</html>